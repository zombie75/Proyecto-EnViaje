...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Agregar servicio de comida</title>
		<link rel="stylesheet" href="css/estilo_agregarcomida.css">
	</head>
	...
	<body>
		<div id="todo">
			...
			<div id="centro">
				<div id="cajaDatos">
					<div id="arriba"><h1>Agregar servicio de comida</h1></div>
					<div id="abajo">
						<form action="agregarcomida2.php" enctype="multipart/form-data" method="post">
