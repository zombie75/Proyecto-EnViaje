...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="css/estilo_crearpicada.css">
	</head>
			...
			<div id="centro">
				...
				<div id="cajaRegistro">
					<div id="inicio">Agregar picada</div>
						<form action="crearpicada2.php" enctype="multipart/form-data" method="post">
							...
							<div id="boton"><input type="submit" value="Agregar picada"></div>
						</form>
				</div>
			</div>
		</div>
