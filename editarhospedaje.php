...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="css/estilo_editarhospedaje.css">
	</head>
	...
	<body>
		<div id="todo">
			...
			<div id="centro">
				<div id="caja">
					<div id="arriba"><h1>Editar servicio de hospedaje</h1></div>
					<div id="abajo">
						<?php
							$id_servicio_hospedaje=$_GET["id_servicio_hospedaje"];
							echo '<form action="editarhospedaje2.php?id_servicio_hospedaje='.$id_servicio_hospedaje.'" enctype="multipart/form-data" method="post">
