...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Agregar servicio de tour</title>
		<link rel="stylesheet" href="css/estilo_agregartour.css">
	</head>
		...
		<div id="todo">
			...
			<div id="centro">
				<div id="caja">
					...
					<div id="arriba"><h1>Agregar servicio de tour</h1></div>
					
					<form action="agregartour2.php" enctype="multipart/form-data" method="post">
						<div id="abajo">
