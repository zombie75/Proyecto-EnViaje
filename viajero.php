...
<head>
	<meta charset="UTF-8">
	<title>Viajero</title>
	<link rel="stylesheet" href="css/estilo_viajero.css">
</head>
	<body>
		<div id="todo">
			<div id="top">
			...
			<div id="centro">
				...
				<?php
					...
					$res = $mysqli->query("SELECT * FROM usuario_viajero WHERE correo_electronico='$correo' ");
					$f = mysqli_fetch_row($res);

					echo "<div id=\"saludo\"><h1>Hola ".$f[1]."</h1></div>";//nombre viajero
					echo "<div id=\"correo\"><h3>".$f[0]."</h3></div>";//correo viajero
					echo "<div id=\"fechaNacimiento\"><h3>Fecha de nacimiento: ".$f[3]."</h3></div>";//fecha nacimiento
					echo "<div id=\"fechaRegistro\"><h3>Fecha de registro: ".$f[2]."</h3></div> ";//nombre viajero
				?>
				</div>
				<div id="linkInicio"><a href='enviaje.php'>Ir al inicio</a></div>
				<div id="linkVer"><a href='picadas.php'>Ver picadas</a></div>
				<div id="linkCrear"><a href='crearpicada.php'>Crear picada</a></div>
			</div>
		</div>
	</body>
</html>